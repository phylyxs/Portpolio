<?php
	...
	$con = mysqli_connect("localhost","root","","database123"); //this is to connect  to the server
	...
	if(preg_match("/^[0-9\-\(\)\/\+\s]*$/", $_POST['phone']) === 0){
	...
	if(count($errors) === 0){
		...
		if($num_row >= 1){
			...
			$sql = "INSERT INTO members(`fname`, `lname`, `phone`, `email`, `DOB`, `conType`, `salt`, `password`) VALUES ('$fname', '$lname', '$phone', '$email', '$DOB', '$conType', '$salt', '$password')";
	...
	<div id="container">
        ...
        <form method="post" action="SignUp.php">
        	<table>
				...
				<tr">
                	<td colspan="2"><input type="text" name="phone" id="phone" placeholder="Phone No" value="<?php if(isset($_POST['phone'])){echo $_POST['phone'];} ?>"></td>
                </tr>
                <tr>
